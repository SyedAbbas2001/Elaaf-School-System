...
const navIcons = {
  'Home': faHome, 'About': faInfoCircle, 'Academics': faBook,
  'Admissions': faClipboardList, 'Events': faCalendarAlt,
  'Gallery': faImages, 'Contact': faPhone,
};
  ...
  return (
    <>
      <nav style={{
        ...
        width: '100%', maxWidth: '100vw', overflowX: 'hidden', // ← FIX 1
        ...
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 70, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            ...
            <button onClick={() => setSearchOpen(!searchOpen)} style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: dark ? 'rgba(255,255,255,0.7)' : '#64748b', transition: 'all 0.2s',
            }}>
              <FontAwesomeIcon icon={searchOpen ? faTimes : faSearch} style={{ width: 14, height: 14 }} />
            </button>
            ...
            <button onClick={toggleDark} style={{
              ...
              color: dark ? '#f59e0b' : '#64748b', transition: 'all 0.2s',
            }}>
        ...
        {searchOpen && (
          <div style={{
            ...
            padding: '16px 16px', // ← FIX 2: 24px → 16px on mobile
            ...
            <form onSubmit={handleSearch} style={{ maxWidth: 600, margin: '0 auto', display: 'flex', gap: 10 }}>
              <input
                ...
                style={{
                  flex: 1, minWidth: 0, padding: '11px 16px', // ← FIX 3: minWidth:0
                  border: `2px solid ${dark ? 'rgba(255,255,255,0.15)' : '#e2e8f0'}`,
              ...
              <button type="submit" style={{
                padding: '11px 20px', borderRadius: 8, flexShrink: 0,
                background: 'var(--crimson)', color: 'white',
        ...
        {menuOpen && (
          <div style={{
            borderTop: `1px solid ${dark ? 'rgba(255,255,255,0.08)' : '#e2e8f0'}`,
            padding: '12px 16px 20px', // ← FIX 4: 24px → 16px
            background: dark ? '#1e293b' : 'white',
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .logo-name div:first-child { font-size: 0.9rem !important; }
        }
      `}</style>
    </>
  );
